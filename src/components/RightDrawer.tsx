...
import { X, Dumbbell, Calendar, Table2, DumbbellIcon, ChartNoAxesCombinedIcon, NotebookTabsIcon } from 'lucide-react';
...
export function RightDrawer({
	...
	const menuItems = [
		...
		{ id: 'progress' as ActiveScreen, label: 'Progresso', icon: ChartNoAxesCombinedIcon },
		{ id: 'overview_table' as ActiveScreen, label: 'Guia de exercícios', icon: NotebookTabsIcon }
	];
